...
use AppBundle\Entity\AlternateTitle;

class LoadGame_AlternateTitleData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $fileContent = $import->CSV_to_array('game_alternatesTitles.csv');
