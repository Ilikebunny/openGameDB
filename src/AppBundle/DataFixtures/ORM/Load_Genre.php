...
class Load_Genre extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $fileContent = $import->CSV_to_array('genres.csv');
        ...
        foreach ($fileContent as $numRow => $row) {
            if ($numRow != 1) {
                ...
                $this->addReference("Genre_" . $entity->getName(), $entity);
