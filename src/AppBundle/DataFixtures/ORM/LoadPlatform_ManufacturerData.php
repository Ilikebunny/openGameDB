...
class LoadPlatform_ManufacturerData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $fileContent = $import->CSV_to_array('platform_manufacturer.csv');
        ...
        foreach ($fileContent as $numRow => $row) {
            if ($numRow != 1) {
                ...
                $entity->addManufacturer($entity2);
