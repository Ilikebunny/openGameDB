...
class LoadArt_GameRootData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $fileContent = $import->CSV_to_array('art_gameRoot.csv');
        ...
        foreach ($fileContent as $numRow => $row) {
            if ($numRow != 1) {
                ...
                $entity2 = $this->getReference("Game_Root" . $row[4]);

                $entity->setGameRoot($entity2);
