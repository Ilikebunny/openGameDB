...
class LoadArt_PlatformData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $fileContent = $import->CSV_to_array('art_platform.csv');
        ...
        foreach ($fileContent as $numRow => $row) {
            if ($numRow != 1) {
                ...
                $entity2 = $this->getReference("Platform_" . $row[4]);
